...
void FilterPanelComponent::updateCurve (int filterType, float cutoffHz, float resonance, float liveCutoffHz, double sampleRate, int slope)
{
    curveDisplay.setParams (filterType, cutoffHz, resonance, sampleRate, slope);
